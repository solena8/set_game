...
var baseDirectory = "C:\\Users\\Home\\Documents\\Set\\Set images\\";
...
function showImage() {
    ...
    img.onload = function() {
        console.log("Image loaded successfully:", img.src);
        // Create a container for the image and its delete button
        ...
        deleteButton.className = "delete-button";
        deleteButton.onclick = function() {
            container.parentNode.removeChild(container); // Remove the container when delete button is clicked
            // Remove the image ID from the downloaded images array
            var index = downloadedImages.indexOf(imageId);
            if (index !== -1) {
                downloadedImages.splice(index, 1);
